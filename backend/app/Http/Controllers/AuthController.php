...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // Jika captcha aktif → tambahkan validasi captcha
        if ($captchaEnabled) {
        ...
        // 2. Jika captcha aktif → verifikasi ke Google
        if ($captchaEnabled && $recaptchaSecret) {
            try {
        ...
        // 3. Cari Admin berdasarkan email atau username
        $input = $request->email;
